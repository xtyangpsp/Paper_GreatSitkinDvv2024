...
# paths and filenames
rootpath = "data_greatsitkin" # rootpath for the project
...
samp_freq = 40                                                  # targeted sampling rate at X samples per seconds
rmresp   = True
rmresp_out = 'VEL'
