...
#local run command
#mpirun -n 2 python /Users/cody/volcanodvv/scripts/ck_seisgo_xcorr_MPI.py

# absolute path parameters
rootpath  = "data_greatsitkin"                                     # root path for this data processing
CCFDIR    = os.path.join(rootpath,'CCF2HR')                                    # dir to store CC data
...
time_norm   = 'ftn'                                                          # 'no' for no normalization, or 'rma', 'one_bit' for normalization in time domain
...
step      = 0.5*cc_len                                                             # overlapping between each cc_len (sec)
