...
#run command
#mpirun -n 2 python /Users/cody/Desktop/SeisVel/ck_merger_MPI.py
...
CCFDIR    = os.path.join(rootpath,'CCF2HR')                            # dir where CC data is stored
...
for ipair in range (rank,splits,size):
    ...
    noise.merge_pairs(ccfiles,pairlist=pair,outdir=MERGEDIR,verbose=flag,to_egf=to_egf,
